...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(5..40)) }
  ...
  describe "GET show" do
    ...
    it "assigns my_sponsored_post to @sponroed_post" do
      get :show, topic_id: my_topic.id, id: my_sponsored_post.id
  ...
  describe "SponsoredPost update" do
